...
bool CLassoInputRule::handleSinglePointEvent(const QSinglePointEvent& event, const CInputInfo& inputInfo)
{
...
bool CLassoInputRule::handleKeyEvent(const QKeyEvent& event, const CInputInfo& inputInfo)
{
