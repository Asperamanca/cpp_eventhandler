...
bool CSelectionInputRule::handleSinglePointEvent(const QSinglePointEvent& event, const CInputInfo& inputInfo)
{
...
bool CSelectionInputRule::handleKeyEvent(const QKeyEvent& event, const CInputInfo& inputInfo)
{
